export default function Details({ Index, Question, Answer, IsCorrectAnswer }) {
  const AnswerCssClasses = `text-2xl w-full text-center ${
    IsCorrectAnswer ? "text-green-700" : "text-red-700"
  }`;
  return (
    <div className="flex flex-col gap-3 justify-center items-center">
      <div className="bg-black h-[3rem] w-[3rem] rounded-full text-white flex justify-center text-4xl text-center">
        {Index}
      </div>
