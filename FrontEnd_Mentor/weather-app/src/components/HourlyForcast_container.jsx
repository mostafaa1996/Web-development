...
export default function HourlyForcastContainer() {
  return (
    <div className="flex flex-col items-center justify-center w-1/3 h-auto bg-[#25253F] rounded-xl">
      <div className="flex flex-row items-center justify-between text-white my-2 w-full p-1">
