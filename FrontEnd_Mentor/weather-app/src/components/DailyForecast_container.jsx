export default function DailyForecastContainer({Day , T_min , T_max , weatherState}) {
    console.log(T_max);
    return (
        <div className="flex flex-col items-center justify-center my-4 w-[11%] h-auto bg-[#25253F] rounded-xl text-white">
                ...
                <img className="p-4 w-[90%] h-[70%]" src={weatherState?.icon||null} alt={weatherState?.label||null} />
